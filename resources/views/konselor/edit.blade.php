    ...
    <div class="w-full overflow-x-hidden flex flex-col justify-center items-center mt-16">
        ...
        <main class="w-full flex flex-grow justify-center p-2 md:p-6 min-h-screen">
            ...
            <div class="flex flex-col items-center bg-white lg:w-2/3 w-5/6 rounded-lg border drop-shadow-lg overflow-auto">
                ...
                <form class="w-full lg:w-4/5 px-4 md:px-10" action="/user/{{ $user->id }}/update" method="post">
                    @csrf
                    @method('PUT')
                    <div class="p-2">
                        <label class="block mb-1 font-bold">Nama</label>
                        <input type="text" id="nama" name="nama" value="{{ $user->nama }}" class="w-full bg-gray-100 h-10 p-2">
                    </div>
                    <div class="p-2">
                        <label class="block mb-1 font-bold">Alamat</label>
                        <input type="text" id="alamat" name="alamat" value="{{ $user->alamat }}" class="w-full bg-gray-100 h-10 p-2">
                    </div>
                    <div class="p-2">
                        <label class="block mb-1 font-bold">Kode</label>
                        <input type="text" id="kode" name="kode" value="{{ $user->kode }}" class="w-full bg-gray-100 h-10 p-2">
                    </div>
